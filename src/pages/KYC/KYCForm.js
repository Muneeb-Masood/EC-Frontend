...
//KYC Form component
const KYCForm = ({ onKYCSubmit, kycVerificaionStatus }) => {
    ...
    const handleSubmit = () => {
        ...
        if (!phoneRegex.test(phoneNumber)) {
            setError(
                "Invalid phone number. Please use the format +92XXXXXXXXX, +92 (XXX) XXXXXXX, +92-XXX-XXXXXXX, or +92 XXX XXXXXXX."
            );
            return;
        }
    ...
    return (
        <div className="kycPage">
            {kycVerificaionStatus === "pending" ? (
                <>
                    <h2>KYC Verification is Pending</h2>
                </>
            ) : (
                <>
                    {kycVerificaionStatus === "revoked" ? (
                        <>
                    ...
                    {/* Generic part (always visible) */}
                    <p>
                        Enter your details, select ID type, upload the document,
                        and submit for KYC verification
                    </p>
                    ...
                    <button
                        ...
                        className="button"
                        disabled={
                            !name || !phoneNumber || !documentType || !picture
                        }
                    >
                        Submit
                    </button>
