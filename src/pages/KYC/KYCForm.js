    ...
    return (
        <div className="kycPage">
            ...
            {kycVerificaionStatus === "pending" ? (
                <>
                    <div>KYC VERIFICATON IS PENDING</div>
                ...
                <>
                    {kycVerificaionStatus === "rejected" && (
                        <>
                            <p>KYC VERIFICATION REJECTED PREVIOULSY</p>
                            <p>REASON: {}</p>
                        </>
                    )}
                    <p>
                        Enter your details, select ID type, upload the required
                        documents, and submit for KYC verification
                    </p>
